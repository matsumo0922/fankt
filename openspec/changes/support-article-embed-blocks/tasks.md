...
- [ ] 2.3 Normalize `videoId ?: contentId` and preserve unknown provider or missing content ID as referenced embed raw JSON
...
- [ ] 3.2 Add mapper tests for block-type precedence, raw fallback selection, reference misses, malformed known blocks, and block ordering
