...
- [x] 2.3 Treat null bodies for article, image, and file as schema mismatches while preserving null-body fallback for unsupported and unknown types
...
- [x] 3.4 Add a public-path regression test proving a null body for a known type becomes `SchemaMismatch` rather than `Body.Unknown`
