...
- [x] 6.4 Run focused cross-platform tests, boundary publication checks, full repository validation, strict OpenSpec validation, and required CI on the final review-fix HEAD
