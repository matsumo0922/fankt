...
#### Scenario: Closed storage can be reacquired for cleanup retry
- **WHEN** one Room storage closes and a later cleanup retry explicitly creates storage again in the same process
