...
- [ ] 1.1 Add nested video and HTML fields to the post body entity with required provider and video ID fields
...
- [ ] 2.2 Preserve Unknown only for unknown post types and surface missing or malformed known fields through the existing SchemaMismatch production contract
...
- [ ] 3.2 Add independent mapper expectations, serialization and URL tests, missing-field tests, and public Fanbox.getPostDetail production-path tests for all three variants
