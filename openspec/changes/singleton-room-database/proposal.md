...
- `fankt/fanbox` の Android / iOS database builder と platform test を変更する。
...
- （agent 仮決め）Android と iOS の production accessor をそれぞれの platform test から直接 2 回呼び、参照同一性を検証する。
